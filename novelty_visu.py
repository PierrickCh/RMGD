...
fig, axes = plt.subplots(4, image_on_line * 2, figsize=(image_on_line * 4, 8))

data_tensor = torch.load(
    "data/saved_tensors/tensor_cache_11_71032d09e67544c41e517d8533b8c0e9babbe99861d733c92020b3387d4f2574.pt", 
    map_location='cuda:0'
)
...
for i in range(number_of_images):
    ...
    comparison = compare_ref_stack(ref_tensor, data_tensor)
